...
Main dashboard: if you put the cursor over the gift, you can check which person you drew
...
If you click on the caption in the center, you can write your Santa letter, which will be visible to any other user, just like you can see any other Santa letter using the list on the right
